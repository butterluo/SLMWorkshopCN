...
if __name__ == "__main__":
    ...
    parser.add_argument("--min_len_chars", type=int, default=32)   #@# the variants of the a prompt is accepted only if the len(variant) in [min_len_chars, max_len_chars]
